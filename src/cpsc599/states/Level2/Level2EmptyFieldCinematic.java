...
public class Level2EmptyFieldCinematic extends CinematicState {
	Player hik, sean, sasha;
    Player cc1, cc2, cc3;

    public Level2EmptyFieldCinematic(OrbGame game, Level level, CameraController cameraController, String nextState) {
    ...
    public void init(OrbGame game) {
        ...
        sean = new Player("Sean", seanSprite, 0, 6, 0);
        sasha = new Player("Sasha", sashaSprite, 0, 8, 0);

        cc1 = new Player("Cow1", ccSprite, 12, 9, 0);
        cc2 = new Player("Cow2", ccSprite, 13, 10, 0);
        cc3 = new Player("Cow3", ccSprite, 13, 8, 0);

        this.cameraController.set(0, 0);
    ...
    protected void loadCinematicActions() {
        ...
        actions.add(CinematicAction.moveToConcurrent(sean, new Vector2(2, 6)));
        actions.add(CinematicAction.moveToConcurrent(sasha, new Vector2(2, 8)));
        actions.add(CinematicAction.wait(0.0f));
        actions.add(CinematicAction.moveToConcurrent(hik, new Vector2(3, 10)));
        actions.add(CinematicAction.moveToConcurrent(sean, new Vector2(3, 9)));
        actions.add(CinematicAction.moveToConcurrent(sasha, new Vector2(3, 11)));
        actions.add(CinematicAction.wait(0.0f));
        actions.add(CinematicAction.moveToConcurrent(hik, new Vector2(5, 10)));
        actions.add(CinematicAction.moveToConcurrent(sean, new Vector2(5, 9)));
        actions.add(CinematicAction.moveToConcurrent(sasha, new Vector2(5, 11)));
        
        actions.add(CinematicAction.panCamera(new Vector2(0, 0), new Vector2(25, 5), this.cameraController));
        ...
        actions.add(CinematicAction.moveTo(hik, new Vector2(6, 10)));
        actions.add(CinematicAction.stepDialogue(this.dialogue));
